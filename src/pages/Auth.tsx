  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 left-1/4 w-64 h-64 bg-liturgical-violet/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-muted-foreground mt-1 uppercase tracking-widest">Diocèse Pierre Claverie</p>
        </div>
        ...
        <p className="text-center text-xs text-muted-foreground mt-6">
          Application réservée aux fidèles du Diocèse Pierre Claverie
        </p>
      </div>
    </div>
  );
